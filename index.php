...
/********************************* Ваш ІД ************************************************/
// Для того щоб статично прописати ID партнера, змініть значення null в строчці з коментарем "//Your ID"
// Приклад:
// Для партнера з ID = 1 правильно буде вказати наступний рядок
// $your_id = 1;

$your_id = null; //Your ID
/*****************************************************************************************/
($your_id) ? $aff_id = $your_id : $aff_id = isset($_GET['a']) ? $_GET['a'] : $_COOKIE['aff_id'] ?? null;
$offer_id = 15;
